...
export default function NotFound({ message }: NotFoundProps) {
  return (
    <div className="ord-page-bg flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-xl rounded-2xl border border-[#e5dbf4] bg-white p-8 text-center shadow-lg">
        ...
        <Link
          to="/"
          className="ord-cta mt-6 inline-flex items-center rounded-full px-5 py-2 text-sm font-semibold"
        >
          Torna all'inizio
        </Link>
      </div>
